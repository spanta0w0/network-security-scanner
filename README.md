# 🔍 network-security-scanner - Automate Your Network Security Checks
...
2. **Select the type of scan** you wish to perform—whether it's a vulnerability check or SSL verification.
